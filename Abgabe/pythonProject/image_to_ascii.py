...
class ArtConverter:
    ...
    def __init__(self, path = "image/Capy.jpg", font_size=12, color_lvl= 8):
        pg.init()
        self.path = path
    ...
    def save_image(self):
        ...
        cv2.imwrite("image/converted_image1.jpg", cv2_img)
    ...
    def draw_cv2_image(self):
        ...
        cv2.imshow("cv2_image", resized_cv2_image)
...
# if the script is run directly, create instance of class and run the programm
